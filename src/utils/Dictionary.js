...
(function () {
    ...
    /**
     * Dictionary instance - manage key:value pairs using string equality (===) for key comparison,
     * rather than the return of a key's toString method
     * @constructor
     * @function
     * @param {object} hash A Dictionary object or Object object to initialize the new Dictionary to.
     * @class The Dictionary class is used to manage key:value pairs, but uses strict equality for key comparison,
     * and does not allow for direct array access (use getItem/addItem/etc methods instead) or for..in interation.
     * Additional sugar methods are included to help with iteration and common tasks.
     */
